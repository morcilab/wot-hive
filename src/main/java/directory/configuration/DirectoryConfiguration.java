...
public class DirectoryConfiguration extends AbstractConfiguration {
    ...
    private boolean embeddedTriplestore;
    ...
    public DirectoryConfiguration(TriplestoreConfiguration triplestore, ServiceConfiguration service, ValidationConfiguration validation) {
        super();
    ...
    public void setEmbeddedTriplestore(boolean embeddedTriplestore) {
        this.embeddedTriplestore = embeddedTriplestore;
    }
    
    public boolean isEmbeddedTriplestore() {
        return embeddedTriplestore;
    }
